<template>
  <div>
    ...
    <p class="homeSearchAddress" v-if="selectedShop != null">
      Here is the closest shop near you: {{ findShop.shopName }}!
      <br> Want something different? <router-link v-bind:to="{ name: 'coffeeShops' }">See all coffee shops</router-link>
    </p>
  </div>
</template>
<script>
